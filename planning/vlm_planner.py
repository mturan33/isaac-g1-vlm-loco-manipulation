...
pre_reach -> walk_to(drawer, 0.85, true) -> reach(drawer) -> grasp -> pull([-1,0,0], 0.25) -> release
...
Example 2 (drawer):
{{"plan": [{{"skill": "pre_reach", "params": {{"target": "drawer_01"}}}}, {{"skill": "walk_to", "params": {{"target": "drawer_01", "stop_distance": 0.85, "hold_arm": true}}}}, {{"skill": "reach", "params": {{"target": "drawer_01"}}}}, {{"skill": "grasp", "params": {{}}}}, {{"skill": "pull", "params": {{"direction": [-1, 0, 0], "distance": 0.25}}}}, {{"skill": "release", "params": {{}}}}]}}
...
class SimplePlanner:
    ...
    def _plan_open_drawer(self, task: str, interactables: list) -> list:
        ...
        return [
            ...
            {"skill": "walk_to", "params": {"target": drawer["id"], "stop_distance": 0.85, "hold_arm": True}},
